...
def template_model(symvar_type='SX'):
    ...
    # xpos = model.set_variable('_x',  'xpos') # zenith angle
    # ypos = model.set_variable('_x',  'ypos') # azimuth angle
    # theta = model.set_variable('_x',  'theta') # orientation kite
    ...
    #print(xtemp)
    A = np.array([[ 1,  0,  0,  0.127*dt*cos(_x[2])*cos(_u[1])],
                  [ 0,  1,  0,  0.127*dt*sin(_x[2])*cos(_u[1])],
                  [ 0,  0,  1,  dt*sin(_u[1])],
                  [ 0,  0,  0,  0]])
